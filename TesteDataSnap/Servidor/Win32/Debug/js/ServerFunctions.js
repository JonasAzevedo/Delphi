...
function TfrmSM(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TfrmSM",connectionInfo);
...
function TMinhaClasseMetodos(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TMinhaClasseMetodos",connectionInfo);

  /*
   * @param psNome [in] - Type on server: string
   * @return result - Type on server: string
   */
  this.RetornarNome = function(psNome) {
    var returnObject = this.executor.executeMethod('RetornarNome', "GET", [psNome], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.psNome = psNome;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.RetornarNome_URL = function(psNome) {
    return this.executor.getMethodURL("RetornarNome", "GET", [psNome], arguments[1])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.RetornarMinhaClasseJsonObject = function() {
    var returnObject = this.executor.executeMethod('RetornarMinhaClasseJsonObject', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.RetornarMinhaClasseJsonObject_URL = function() {
    return this.executor.getMethodURL("RetornarMinhaClasseJsonObject", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONArray
   */
  this.RetornarListaClasse = function() {
    var returnObject = this.executor.executeMethod('RetornarListaClasse', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.RetornarListaClasse_URL = function() {
    return this.executor.getMethodURL("RetornarListaClasse", "GET", [], arguments[0])[0];
  };

  /*
   * @param poListaClasse [in] - Type on server: TJSONArray
   * @return result - Type on server: string
   */
  this.ListarClasses = function(poListaClasse) {
    var returnObject = this.executor.executeMethod('"ListarClasses"', "POST", [poListaClasse], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.poListaClasse = poListaClasse;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  /*
   * @param poMinhaClasse [in] - Type on server: TJSONObject
   * @return result - Type on server: string
   */
  this.updateInserirRegistroJsonObject = function(poMinhaClasse) {
    var returnObject = this.executor.executeMethod('InserirRegistroJsonObject', "POST", [poMinhaClasse], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.poMinhaClasse = poMinhaClasse;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.TesteJsonUnMarshal = function() {
    this.executor.executeMethod('TesteJsonUnMarshal', "GET", [], arguments[0], false, arguments[1], arguments[2]);
  };

  this.TesteJsonUnMarshal_URL = function() {
    return this.executor.getMethodURL("TesteJsonUnMarshal", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TfrmSM": ["EchoString","ReverseString"],
  "TMinhaClasseMetodos": ["RetornarNome","RetornarMinhaClasseJsonObject","RetornarListaClasse","ListarClasses","updateInserirRegistroJsonObject","TesteJsonUnMarshal"]
};
