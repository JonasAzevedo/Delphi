...
uses
  ...
  AdvSmoothGDIP, GDIPFill, Math, GDIPPictureContainer, ImgList, AdvStyleIF;
...
const
  ...
  // Progress Animation
  // Glow Animation
  // Improve/add BasicInfo positions 
  //------
...
function DrawGDIPText(g: TGPGraphics; Text: string; P: TPoint; Font: TFont; GradType: TAdvGradientType; Pic: TAdvGDIPPicture; HatchStyle: THatchStyle; OpacityStart, OpacityEnd: Byte; ColorStart, ColorEnd: TColor; CalcSize: Boolean; Angle: integer): TSize;
var
  ff: TGPFontFamily;
  fs, x, y: Integer;
  sf: TGPStringFormat;
...
begin
  ...
  if (Item.Text <> '') then
    DrawGDIPText(g, Item.Text, Point(X, Y), Item.Font, gtSolid, nil, HatchStyleHorizontal, 255, 255, Item.Font.Color, Item.Font.Color, False, 0);
...
begin
  ...
  with SplashScreen.BasicProgramInfo.ProgramName do
    PNS := DrawGDIPText(g, Text, Point(0, 0), Font, GradientType, Picture, HatchStyle, OpacityStart, OpacityEnd, ColorStart, ColorEnd, True, Angle);
  ...
  with SplashScreen.BasicProgramInfo.ProgramVersion do
    PVS := DrawGDIPText(g, Text, Point(0, 0), Font, GradientType, Picture, HatchStyle, OpacityStart, OpacityEnd, ColorStart, ColorEnd, True, Angle);
  ...
  with SplashScreen.BasicProgramInfo.ProgramName do
    DrawGDIPText(g, Text, Point(X, Y), Font, GradientType, Picture, HatchStyle, OpacityStart, OpacityEnd, ColorStart, ColorEnd, False, Angle);
  ...
  DrawGDIPText(g, SplashScreen.BasicProgramInfo.CopyRight, Point(X, Y), SplashScreen.BasicProgramInfo.CopyRightFont,
               gtSolid, nil, HatchStyleHorizontal, 255, 255, SplashScreen.BasicProgramInfo.CopyRightFont.Color, SplashScreen.BasicProgramInfo.CopyRightFont.Color, False, 0);
