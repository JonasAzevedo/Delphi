...
{$ENDIF}
  ...
  BLD_VER = 27; // Build nr.
  DATE_VER = 'Feb, 2009'; // Month version
...
begin
  ...
  begin
    ...
    Canvas.TextOut(r.Left + 4,r.Top + 4,FPlanner.ClassName + ' : Copyright © 1999 - 2008 by TMS software');
  end;
  {$ENDIF}
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              Planner.PlannerImages.Draw(Canvas, r.Left, r.Top, GroupImage);
              r.Left := r.Left + 2 + Planner.PlannerImages.Width;
            end;
