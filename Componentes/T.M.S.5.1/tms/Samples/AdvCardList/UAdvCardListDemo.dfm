object Form1: TForm1
  ...
  object AdvCardList1: TAdvCardList
    ...
    BorderColor = 10789025
    CardEditingAppearance.BevelOuter = bvNone
    CardEditingAppearance.BorderColor = 13603685
    CardEditingAppearance.CaptionColor.Color = 9758459
    CardEditingAppearance.CaptionColor.ColorTo = 1414638
    CardEditingAppearance.CaptionColor.Direction = gdVertical
    CardEditingAppearance.CaptionBorderColor = 13603685
    CardEditingAppearance.CaptionBorderWidth = 0
    CardEditingAppearance.CaptionFont.Charset = DEFAULT_CHARSET
    CardEditingAppearance.CaptionFont.Color = clBlack
    ...
    CardEditingAppearance.Color.ColorTo = 16381425
    ...
    CardNormalAppearance.BorderColor = 13603685
    CardNormalAppearance.CaptionColor.Color = 16773091
    CardNormalAppearance.CaptionColor.ColorTo = 16765615
    CardNormalAppearance.CaptionColor.Direction = gdVertical
    CardNormalAppearance.CaptionBorderColor = 13603685
    CardNormalAppearance.CaptionBorderWidth = 0
    CardNormalAppearance.CaptionFont.Charset = DEFAULT_CHARSET
    CardNormalAppearance.CaptionFont.Color = 7485192
    ...
    CardNormalAppearance.Color.ColorTo = 16381425
    ...
    CardSelectedAppearance.BorderColor = 13603685
    CardSelectedAppearance.CaptionColor.Color = 9758459
    CardSelectedAppearance.CaptionColor.ColorTo = 1414638
    CardSelectedAppearance.CaptionColor.Direction = gdVertical
    CardSelectedAppearance.CaptionBorderColor = 13603685
    CardSelectedAppearance.CaptionBorderWidth = 0
    CardSelectedAppearance.CaptionFont.Charset = DEFAULT_CHARSET
    CardSelectedAppearance.CaptionFont.Color = clBlack
    ...
    CardSelectedAppearance.Color.ColorTo = 16381425
    ...
    CardHoverAppearance.BorderColor = 13603685
    CardHoverAppearance.CaptionColor.Color = 16773091
    CardHoverAppearance.CaptionColor.ColorTo = 16765615
    CardHoverAppearance.CaptionColor.Direction = gdVertical
    CardHoverAppearance.CaptionBorderColor = 13603685
    CardHoverAppearance.CaptionBorderWidth = 0
    CardHoverAppearance.CaptionFont.Charset = DEFAULT_CHARSET
    CardHoverAppearance.CaptionFont.Color = 7485192
    ...
    CardHoverAppearance.Color.ColorTo = 16381425
    ...
    CardTemplate.ItemLabelWidth = 60
    CardTemplate.Items = <
      item
        Caption = 'Type:'
    ...
    CardVertSpacing = 10
    Color.Color = 15918293
    Color.ColorTo = 15918293
