object Form1: TForm1
  ...
  object PlannerOutlookExchange1: TPlannerOutlookExchange
    Planner = Planner1
    OnAppointmentToItem = PlannerOutlookExchange1AppointmentToItem
    OnAcceptAppointment = PlannerOutlookExchange1AcceptAppointment
    Left = 624
    Top = 24
  end
end
