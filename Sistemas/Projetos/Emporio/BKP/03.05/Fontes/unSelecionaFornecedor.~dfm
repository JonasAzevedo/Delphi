object frmSelecionaFornecedor: TfrmSelecionaFornecedor
  ...
  Caption = 'EMP'#211'RIO  -->  Selecionando Fornecedor'
  ClientHeight = 422
  ClientWidth = 543
  Color = clBtnFace
  ...
  object grpBxFornecedores: TGroupBox
    ...
    object DBGridFornecedores: TDBGrid
      ...
      OnDblClick = btBtnSelecionarFornecedorClick
  ...
  object grpBxPesquisa: TGroupBox
    ...
    object rdBtnRazaoSocial: TRadioButton
      Left = 8
      Top = 35
      Width = 83
      Height = 17
  ...
  object btBtnSelecionarFornecedor: TBitBtn
    ...
    Width = 201
    Height = 34
    Hint = 'Selecionar Fornecedor para Compra Atual'
    Caption = 'Selecionar Fornecedor da Compra'
    TabOrder = 5
    OnClick = btBtnSelecionarFornecedorClick
  end
  object btBtnMostrarTodosFornecedores: TBitBtn
    Left = 385
    Top = 341
    Width = 150
    Height = 25
    ...
    TabOrder = 6
    OnClick = btBtnMostrarTodosFornecedoresClick
  end
