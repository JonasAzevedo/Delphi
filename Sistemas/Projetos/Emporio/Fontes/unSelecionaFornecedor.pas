...
begin
  ...
  else if ((tela = 'relatorioContaPagar')or(tela='relatorioSaida'))then
...
begin
  ...
  else if (tela='relatorioSaida') then
    begin
    frmSelecionaSaida.codFornecedor := Self.codigo;
    frmSelecionaSaida.edFornecedor.Text := Self.razao_social;
    end;
