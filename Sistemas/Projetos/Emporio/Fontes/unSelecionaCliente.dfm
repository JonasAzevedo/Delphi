object frmSelecionaCliente: TfrmSelecionaCliente
  Left = 496
  Top = 174
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'EMP'#211'RIO --> Selecionando Cliente'
  ClientHeight = 422
  ClientWidth = 543
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object grpBxClientes: TGroupBox
    Left = 0
    Top = 81
    Width = 543
    Height = 249
    ...
    object DBGridClientes: TDBGrid
      ...
      OnDblClick = btBtnSelecionarClienteClick
      OnExit = DBGridClientesExit
      Columns = <
        item
          Expanded = False
          FieldName = 'NOME'
  ...
  object btBtnNovoCliente: TBitBtn
    Left = 386
    Top = 368
    Width = 149
    Height = 25
    Hint = 'Abrir Cadastro de um Novo Cliente'
    Caption = 'Cadastrar Novo Cliente'
    TabOrder = 1
    OnClick = btBtnNovoClienteClick
  end
  object grpBxPesquisa: TGroupBox
    ...
    object rdBtnCodigo: TRadioButton
      ...
      Width = 57
      Height = 17
      Hint = 'Pesquisar por C'#243'digo do Cliente'
      Caption = 'C'#243'digo'
      TabOrder = 0
    ...
    object rdBtnNome: TRadioButton
      ...
      Width = 65
      Height = 17
      Hint = 'Pesquisar por Nome do Cliente'
      Caption = 'Nome'
      TabOrder = 1
  ...
  object btBtnSelecionarCliente: TBitBtn
    ...
    Width = 201
    Height = 34
    Hint = 'Selecionar Cliente para Venda Atual'
    Caption = 'Selecionar Cliente da Venda'
    TabOrder = 5
    OnClick = btBtnSelecionarClienteClick
  end
  object btBtnMostrarTodosClientes: TBitBtn
    Left = 385
    Top = 341
    Width = 150
    Height = 25
    Hint = 'Mostrar Todos os Clientes Cadastrados'
    Caption = 'Mostrar Todos Clientes'
    TabOrder = 6
    OnClick = btBtnMostrarTodosClientesClick
  end
