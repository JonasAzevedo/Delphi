...
uses unDataModule, unVenda, unCliente, unSelecionaContaReceber,
  unSelecionaEntradas;
...
procedure TfrmSelecionaCliente.DBGridClientesCellClick(
  Column: TColumn);
begin
...
begin
  ...
  else if ((tela = 'relatorioContaReceber')or(tela = 'relatorioEntrada')) then
...
begin
  ...
  else if (tela = 'relatorioContaReceber') then
    begin
    frmSelecionaContaReceber.codCliente := Self.codigo;
    frmSelecionaContaReceber.edCliente.Text := Self.nome;
    end
  else if (tela = 'relatorioEntrada') then
    begin
    frmSelecionaEntrada.codCliente := Self.codigo;
    frmSelecionaEntrada.edCliente.Text := Self.nome;
    end;
