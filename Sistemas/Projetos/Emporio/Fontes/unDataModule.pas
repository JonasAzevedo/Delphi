...
type
  TDM = class(TDataModule)
    ...
    qryBalanca: TSQLQuery;
    qryBalancaCODIGO: TIntegerField;
    qryBalancaATIVA: TIntegerField;
    qryBalancaBALANCA: TStringField;
    qryBalancaPORTA_SERIAL: TStringField;
    qryBalancaVELOCIDADE: TIntegerField;
    qryBalancaDATA_BITS: TIntegerField;
    qryBalancaPARIDADE: TStringField;
    qryBalancaSTOP_BITS: TStringField;
    qryBalancaHANDSHAKING: TStringField;
    qryBalancaTIME_OUT: TIntegerField;
    qryBalancaMONITORA: TIntegerField;
    dspBalanca: TDataSetProvider;
    cdsBalanca: TClientDataSet;
    cdsBalancaCODIGO: TIntegerField;
    cdsBalancaATIVA: TIntegerField;
    cdsBalancaBALANCA: TStringField;
    cdsBalancaPORTA_SERIAL: TStringField;
    cdsBalancaVELOCIDADE: TIntegerField;
    cdsBalancaDATA_BITS: TIntegerField;
    cdsBalancaPARIDADE: TStringField;
    cdsBalancaSTOP_BITS: TStringField;
    cdsBalancaHANDSHAKING: TStringField;
    cdsBalancaTIME_OUT: TIntegerField;
    cdsBalancaMONITORA: TIntegerField;
    dsBalanca: TDataSource;
  private
