...
uses Windows, Classes, SysUtils, ResourceModule, Menus;

type

TMenuResource = class (TWriteableResource)
  private
...
destructor TMenuResource.Destroy;
begin
  inherited;
end;

procedure TMenuResource.ExportToStream(stream: TStream; const ext : string);
begin
  raise Exception.Create ('Not yet implemented')
end;

class function TMenuResource.GetFilter: string;
begin
  result := ''
end;

procedure TMenuResource.GetItems (items : TMenuItem);
var
  p : PChar;
  owner : TComponent;
...
class function TMenuResource.GetResourceType: word;
begin
  result := word (RT_MENU);
end;

class function TMenuResource.GetResourceTypeClass: string;
begin
  result := rstMenu
end;

procedure TMenuResource.Initialize;
var
  p : PChar;
begin
...
procedure TMenuResource.SetItems(items: TMenuItem);
var
  st : TMemoryStream;
  offset : Integer;
  i : Integer;
...
initialization
  RegisterWriteableResources ([TMenuResource]);
end.
