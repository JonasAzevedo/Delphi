...
begin
  ...
  quotes := '';
  quotes := stringgrid1.Cells[1,1];
  for i := 2 to stringgrid1.RowCount - 1 do
    quotes := quotes + '%2C'+stringgrid1.Cells[1,i];

  for i := 1 to stringgrid1.RowCount - 1 do
  begin
    with webdata1.Data.Add do
    begin
      scanfirst := '/q?s='+stringgrid1.Cells[1,i]+'"';
      scanfrom := '<td class="yfnc_tabledata1" nowrap align="right"><b>';
      scanto := '</b>';
