object frmSelecionaProduto: TfrmSelecionaProduto
  ...
  Caption = 'NOIVA LINDA --> Selecionando Produto'
  Color = clBtnFace
  ...
  object grpBxProdutos: TGroupBox
    Left = 0
    Top = 81
    Width = 593
    Height = 249
    ...
    object DBGridProdutos: TDBGrid
      ...
      OnDblClick = btBtnSelecionarProdutoClick
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Valor Loca'#231#227'o'
          Width = 80
          Visible = True
        end
        item
  ...
  object btBtnNovoProduto: TBitBtn
    Left = 7
    Top = 462
    Width = 180
    Height = 35
    Hint = 'Abrir Cadastro de um Novo Produto'
    Caption = 'Cadastrar Novo Produto'
    TabOrder = 1
    OnClick = btBtnNovoProdutoClick
  end
  object grpBxPesquisa: TGroupBox
    ...
    object rdBtnCodigo: TRadioButton
      ...
      Width = 57
      Height = 17
      Hint = 'Pesquisar por C'#243'digo do Produto'
      Caption = 'C'#243'digo'
      TabOrder = 0
  ...
  object btBtnSelecionarProduto: TBitBtn
    Left = 406
    Top = 462
    Width = 180
    Height = 35
    Hint = 'Selecionar Produto para Opera'#231#227'o Atual'
    Caption = 'Selecionar Produto'
    TabOrder = 5
    OnClick = btBtnSelecionarProdutoClick
  end
  ...
  object PopupMenu: TPopupMenu
    Left = 455
    Top = 21
    object ppMnMostrarTodosProdutos: TMenuItem
      Caption = 'Mostrar Todos Produtos'
      Hint = 'Mostrar Todos os Produtos Cadastrados'
      OnClick = ppMnMostrarTodosProdutosClick
    end
  end
end
