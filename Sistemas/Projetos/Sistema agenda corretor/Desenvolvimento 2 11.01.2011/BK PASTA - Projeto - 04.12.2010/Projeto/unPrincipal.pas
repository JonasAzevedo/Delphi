...
type
  TfrmPrincipal = class(TForm)
    ...
    procedure mnItClientesClick(Sender: TObject);
    procedure mnItTipoImovelClick(Sender: TObject);
    procedure mnItPessoaFisicaClick(Sender: TObject);
    ...
    procedure lblEsconderDetalhesAgenciamentosStandByClick(
      Sender: TObject);
    procedure mnItPessoaJuridicaClick(Sender: TObject);
...
uses
  ...
  unPesquisarImoveisInteresse, unPesquisarVendas; //unCadVenda;
...
procedure TfrmPrincipal.mnItClientesClick(Sender: TObject);
begin
  try
...
procedure TfrmPrincipal.mnItPessoaFisicaClick(Sender: TObject);
begin
  try
...
procedure TfrmPrincipal.mnItPessoaJuridicaClick(Sender: TObject);
begin
  try
