...
type
  TfrmPrincipal = class(TForm)
    ...
    zQryAgenciamentosStandByVALOR_TOTAL: TStringField;
    ...
    zQryAgenciamentosStandByVALOR_IMOVEL: TStringField;
    ...
    zQryAgenciamentosExpirandoVALOR_TOTAL: TStringField;
    ...
    zQryAgenciamentosExpirandoVALOR_IMOVEL: TStringField;
...
uses
  ...
  unCadClientePessoaJuridica; //unCadVenda;
