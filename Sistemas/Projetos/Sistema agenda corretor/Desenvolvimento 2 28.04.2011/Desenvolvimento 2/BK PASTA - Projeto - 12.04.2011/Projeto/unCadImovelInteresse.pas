...
type
  TfrmCadImovelInteresse = class(TfrmCadastroBasico)
    ...
    btBtnSelecionarCaracteristicas: TBitBtn;
    ...
    procedure btBtnSelecionarCaracteristicasFinanciamentoClick(
      Sender: TObject);
    procedure btBtnSelecionarCaracteristicasClick(Sender: TObject);
...
uses unConstantes, unDM, unSelecionaRegistroImovel, unSelecionaRegistroTipoImovel,
  ...
  unSelecionaRegistroRegiaoLocalidade;
...
procedure TfrmCadImovelInteresse.btBtnSelecionarCaracteristicasVistaClick(
  Sender: TObject);
var
...
procedure TfrmCadImovelInteresse.btBtnSelecionarCaracteristicasFinanciamentoClick(
  Sender: TObject);
var
  vParametros: OleVariant;
begin
...
procedure TfrmCadImovelInteresse.btBtnSelecionarCaracteristicasClick(
  Sender: TObject);
var
  vParametros: OleVariant;          
begin
