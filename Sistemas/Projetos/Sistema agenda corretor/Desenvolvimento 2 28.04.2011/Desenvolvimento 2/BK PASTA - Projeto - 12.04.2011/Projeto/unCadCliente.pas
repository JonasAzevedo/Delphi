...
begin
  inherited;
  MostrarHintCampos('Cliente pela Identidade', 'Identidade do Cliente');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'Data de Nascimento do Cliente');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'Profissão do Cliente');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'Cidade do Cliente');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'CEP do Cliente');
end;
