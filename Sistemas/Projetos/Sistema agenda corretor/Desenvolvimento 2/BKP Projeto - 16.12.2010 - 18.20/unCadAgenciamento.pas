...
type
  TfrmCadAgenciamento = class(TfrmCadastroBasico)
    ...
    zQryDadosVALOR_TOTAL: TStringField;
    zQryDadosPGTO_VISTA_CACH: TStringField;
    zQryDadosPGTO_VISTA_VALOR_BEM: TStringField;
    zQryDadosPGTO_VISTA_DESCRICAO_BEM: TStringField;
    zQryDadosPGTO_FINCTO_CACH_FINANCIADO: TStringField;
    zQryDadosPGTO_FINCTO_CACH: TStringField;
    zQryDadosPGTO_FINCTO_VALOR_BEM: TStringField;
    ...
    cdsDadosVALOR_TOTAL: TStringField;
    cdsDadosPGTO_VISTA_CACH: TStringField;
    cdsDadosPGTO_VISTA_VALOR_BEM: TStringField;
    cdsDadosPGTO_VISTA_DESCRICAO_BEM: TStringField;
    cdsDadosPGTO_FINCTO_CACH_FINANCIADO: TStringField;
    cdsDadosPGTO_FINCTO_CACH: TStringField;
    cdsDadosPGTO_FINCTO_VALOR_BEM: TStringField;
    ...
    procedure plsEdPessoaClick(Sender: TObject);
...
uses unPesquisandoAgenciamento, unConstantes, unDM,
  ...
  begin//1
    ...
    begin
      try
        ...
        frmCadPessoaFisica.passarParametro(PRM_EDITAR_PESSOA_AGENCIAMENTO_STAND_BY,
          FORM_CAD_AGENCIAMENTOS);
        frmCadPessoaFisica.passarParametro(PRM_CARREGA_REGISTRO_CODIGO,
          Self.FoAgenciamento.getFk_Pessoa_Fisica);
  ...
  begin
    ...
    begin
      try
        ...
        frmCadPessoaJuridica.passarParametro(PRM_EDITAR_PESSOA_AGENCIAMENTO_STAND_BY,
          FORM_CAD_AGENCIAMENTOS);
        frmCadPessoaJuridica.passarParametro(PRM_CARREGA_REGISTRO_CODIGO,
          Self.FoAgenciamento.getFk_Pessoa_Juridica);
...
procedure TfrmCadAgenciamento.plsEdPessoaClick(Sender: TObject);
begin
  inherited;
