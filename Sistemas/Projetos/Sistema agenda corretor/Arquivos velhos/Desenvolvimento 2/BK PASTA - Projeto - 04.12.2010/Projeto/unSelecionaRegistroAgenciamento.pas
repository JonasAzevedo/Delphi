...
begin
  inherited;
  Self.FiCodigo := cdsSelecionarRegistroCODIGO_AGENCIAMENTO.AsInteger;
  Self.FsNome := cdsSelecionarRegistroNOME_TIPO_PESSOA.AsString + ' - ' +
