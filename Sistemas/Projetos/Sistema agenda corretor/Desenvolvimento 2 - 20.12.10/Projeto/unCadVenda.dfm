inherited frmCadVenda: TfrmCadVenda
  ...
  inherited grpBxDados: TGroupBox
    ...
    object pnlValores: TPanel
      ...
      object lblPercentualSobreComissao: TLabel
        ...
        Width = 133
        Height = 13
        Caption = 'Percentual Sobre Comiss'#227'o:'
      end
      object lblPercentualSobreVenda: TLabel
        ...
        Width = 119
        Height = 13
        Caption = 'Percentual Sobre Venda:'
      end
      ...
      object plsCbBxDeduzirBemNegociavel: TPlsComboBox
        ...
        ItemHeight = 13
        TabOrder = 3
        OnChange = plsCbBxDeduzirBemNegociavelChange
        Items.Strings = (
          'SIM'
          'N'#195'O')
        plsCorRecebeFoco = clSilver
  ...
  inherited zQryDados: TZQuery
    ...
    object zQryDadosCOD_FK_CLIENTE: TIntegerField
  ...
  inherited cdsDados: TClientDataSet
    ...
    object cdsDadosCOD_FK_CLIENTE: TIntegerField
      FieldName = 'COD_FK_CLIENTE'
      Required = True
    end
