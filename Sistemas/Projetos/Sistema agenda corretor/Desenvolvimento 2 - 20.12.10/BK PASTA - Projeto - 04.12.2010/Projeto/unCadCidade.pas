...
begin
  ...
  //verifica se cidade não está associado a um cliente
  ...
  //verifica se cidade não está associado a uma pessoa_fisica
  if(bPodeDeletar)then
  begin
    ...
    begin
      MessageDlg('Cidade não pode ser deletada, pois existe uma pessoa física desta cidade.',
        mtInformation, [mbOK], 0);
      bPodeDeletar := False;
    end;
  end;
  ...
  begin
    ...
    begin
      MessageDlg('Cidade não pode ser deletada, pois existe uma pessoa jurídica desta cidade.',
        mtInformation, [mbOK], 0);
      bPodeDeletar := False;
    end;
  end;
...
(*
  ...
  begin
    ...
    begin
      ...
      begin
        sValor := plsEdCodigo.Text + Key; //verificar se Key é caracter válido
...
(*
  ...
  begin
    ...
    begin
      sValor := plsEdNome.Text + Key; //verificar se Key é caracter válido
